...
const translationData: Record<Language, Record<string, string>> = {
  tr: {
    ...
    'exp.1.description': 'Bankacılık personellerinin muhasebe ve finans operasyonlarını kolaylaştıran arayüz uygulamalarını geliştiriyorum.',
    // Experience 2 - Akinon
    'exp.2.role': 'Front-End Developer',
    'exp.2.periodStart': 'Ağu 2022',
    'exp.2.periodEnd': 'Ağu 2023',
    'exp.2.periodDuration': '1 yıl',
    'exp.2.description': 'SPX, Underarmour, Brandys, Evidea, Vakko, Altınçadır gibi markaların e-ticaret sitelerine yazılımlar geliştirdim.',
    ...
    'exp.3.description': 'Ön elemeleri geçtikten sonra hızlandırılmış eğitimi tamamladım ve bitirme projesiyle mezun oldum.',
    ...
    'exp.4.description': 'Arçelik sonrası, depo, kodlama, personel işleri ve emlakçılık gibi çeşitli küçük işletmelerde çalıştım. 2020\'den itibaren yazılım alanlarında eğitimler aldım.',
    ...
    'exp.5.description': 'MS Office VBA ile zamandan %70\'e varan tasarruf sağladık.',
    // Experience 6 - KVK
    'exp.6.role': 'Lojistik Sorumlusu',
    'exp.6.periodStart': 'Ara 2010',
    'exp.6.periodEnd': 'Tem 2014',
    'exp.6.periodDuration': '3 yıl 8 ay',
    'exp.6.description': 'MS Office VBA ile yazdığım programlar sayesinde sistem üzerinden zamandan tasarruflar sağladık.',
    ...
    'project.1.description': 'E-ticaret platformu. Kullanıcı dostu arayüz, ürün yönetimi ve stok takibi özellikleri.',
    // Project 2 - NTV Haber
    'project.2.title': 'NTV Haber',
    'project.2.description': 'Haber portalı. Gerçek zamanlı haber akışı ve multimedya içerik yönetimi.',
    // Project 3 - Under Armour
    'project.3.title': 'Under Armour',
    'project.3.description': 'Spor giyim e-ticaret platformu. Modern tasarım ve kullanıcı deneyimi odaklı.',
    // Project 4 - Vakko
    'project.4.title': 'Vakko',
    'project.4.description': 'Lüks moda markası e-ticaret sitesi. Şık tasarım ve premium kullanıcı deneyimi.',
    // Project 5 - SPX
    'project.5.title': 'SPX',
    'project.5.description': 'Spor ve fitness platformu. Kullanıcı etkileşimi ve performans takibi.',
    // Project 6 - Siyer Eşleştirme
    'project.6.title': 'Siyer Eşleştirme',
    'project.6.description': 'Eğitim platformu. İnteraktif öğrenme ve eşleştirme oyunu.',
    ...
    'contact.error.web3formsKey': 'Web3Forms access key bulunamadı. Lütfen .env dosyasını kontrol edin.',
    'contact.error.formSubmit': 'Form gönderiminde bir hata oluştu.',
    'contact.error.sendFailed': 'Mesaj gönderilirken bir hata oluştu. Lütfen tekrar deneyin.',
  ...
  en: {
    ...
    'exp.1.description': 'I develop interface applications that facilitate accounting and finance operations for banking personnel.',
    // Experience 2 - Akinon
    'exp.2.role': 'Front-End Developer',
    'exp.2.periodStart': 'Aug 2022',
    'exp.2.periodEnd': 'Aug 2023',
    'exp.2.periodDuration': '1 year',
    'exp.2.description': 'I developed software for e-commerce sites of brands such as SPX, Underarmour, Brandys, Evidea, Vakko, Altınçadır.',
    // Experience 3 - Kodluyoruz
    'exp.3.company': 'Kodluyoruz',
    ...
    'exp.3.description': 'After passing the preliminary eliminations, I completed the intensive training and graduated with a final project.',
    ...
    'exp.4.description': 'After Arçelik, I worked in various small businesses such as warehouse, coding, personnel affairs, and real estate. Since 2020, I have been receiving training in software fields.',
    // Experience 5 - Arçelik
    'exp.5.role': 'Procurement Officer',
    'exp.5.periodStart': 'Jul 2014',
    'exp.5.periodEnd': 'Oct 2015',
    'exp.5.periodDuration': '1 year 4 months',
    'exp.5.description': 'We achieved up to 70% time savings with MS Office VBA.',
    // Experience 6 - KVK
    'exp.6.role': 'Logistics Supervisor',
    'exp.6.periodStart': 'Dec 2010',
    'exp.6.periodEnd': 'Jul 2014',
    'exp.6.periodDuration': '3 years 8 months',
    'exp.6.description': 'Thanks to the programs I wrote with MS Office VBA, we achieved time savings through the system.',
    ...
    // Project 1 - Evidea
    'project.1.title': 'Evidea',
    'project.1.description': 'E-commerce platform. User-friendly interface, product management and inventory tracking features.',
    // Project 2 - NTV Haber
    'project.2.title': 'NTV News',
    'project.2.description': 'News portal. Real-time news feed and multimedia content management.',
    // Project 3 - Under Armour
    'project.3.title': 'Under Armour',
    'project.3.description': 'Sports apparel e-commerce platform. Modern design and user experience focused.',
    // Project 4 - Vakko
    'project.4.title': 'Vakko',
    'project.4.description': 'Luxury fashion brand e-commerce site. Elegant design and premium user experience.',
    // Project 5 - SPX
    'project.5.title': 'SPX',
    'project.5.description': 'Sports and fitness platform. User interaction and performance tracking.',
    // Project 6 - Siyer Eşleştirme
    'project.6.title': 'Siyer Matching',
    'project.6.description': 'Educational platform. Interactive learning and matching game.',
    ...
    'contact.error.web3formsKey': 'Web3Forms access key not found. Please check the .env file.',
  ...
  ar: {
    ...
    'exp.1.description': 'أطور تطبيقات واجهة تسهل عمليات المحاسبة والمالية لموظفي البنوك.',
    // Experience 2 - Akinon
    'exp.2.role': 'مطور Front-End',
    'exp.2.periodStart': 'أغسطس 2022',
    'exp.2.periodEnd': 'أغسطس 2023',
    'exp.2.periodDuration': 'سنة واحدة',
    'exp.2.description': 'طورت برمجيات لمواقع التجارة الإلكترونية لعلامات تجارية مثل SPX و Underarmour و Brandys و Evidea و Vakko و Altınçadır.',
    // Experience 3 - Kodluyoruz
    'exp.3.company': 'Kodluyoruz',
    ...
    'exp.3.description': 'بعد اجتياز التصفيات الأولية، أكملت التدريب المكثف وتخرجت بمشروع نهائي.',
    // Experience 4 - Kariyer Geçişi
    ...
    'exp.4.description': 'بعد Arçelik، عملت في أعمال تجارية صغيرة متنوعة مثل المستودعات والبرمجة وشؤون الموظفين والعقارات. منذ عام 2020، أتلقى تدريبات في مجالات البرمجيات.',
    // Experience 5 - Arçelik
    'exp.5.role': 'موظف المشتريات',
    'exp.5.periodStart': 'يوليو 2014',
    'exp.5.periodEnd': 'أكتوبر 2015',
    'exp.5.periodDuration': 'سنة واحدة و 4 أشهر',
    'exp.5.description': 'حققنا توفيراً في الوقت يصل إلى 70% باستخدام MS Office VBA.',
    // Experience 6 - KVK
    'exp.6.role': 'مشرف اللوجستيات',
    'exp.6.periodStart': 'ديسمبر 2010',
    'exp.6.periodEnd': 'يوليو 2014',
    'exp.6.periodDuration': '3 سنوات و 8 أشهر',
    'exp.6.description': 'بفضل البرامج التي كتبتها باستخدام MS Office VBA، حققنا توفيرات في الوقت من خلال النظام.',
    ...
    // Project 1 - Evidea
    'project.1.title': 'Evidea',
    'project.1.description': 'منصة التجارة الإلكترونية. واجهة سهلة الاستخدام، إدارة المنتجات وميزات تتبع المخزون.',
    // Project 2 - NTV Haber
    'project.2.title': 'NTV News',
    'project.2.description': 'بوابة إخبارية. تدفق الأخبار في الوقت الفعلي وإدارة المحتوى متعدد الوسائط.',
    // Project 3 - Under Armour
    'project.3.title': 'Under Armour',
    'project.3.description': 'منصة التجارة الإلكترونية للملابس الرياضية. تصميم حديث ومركز على تجربة المستخدم.',
    // Project 4 - Vakko
    'project.4.title': 'Vakko',
    'project.4.description': 'موقع التجارة الإلكترونية لعلامة الأزياء الفاخرة. تصميم أنيق وتجربة مستخدم متميزة.',
    // Project 5 - SPX
    'project.5.title': 'SPX',
    'project.5.description': 'منصة الرياضة واللياقة البدنية. تفاعل المستخدم وتتبع الأداء.',
    // Project 6 - Siyer Eşleştirme
    ...
    'contact.error.web3formsKey': 'لم يتم العثور على مفتاح الوصول Web3Forms. يرجى التحقق من ملف .env.',
